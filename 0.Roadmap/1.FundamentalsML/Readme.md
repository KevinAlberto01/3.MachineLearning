...
|------------------------|------------------------|-------------------| 
|<img src="https://github.com/KevinAlberto01/3.MachineLearning/blob/main/0.Roadmap/1.FundamentalsML/2.HousePricePrediction/Img/1.BasicModel.jpeg?raw=true" alt="Basic Model" style="width: 100%; height: auto;">|<img src="https://github.com/KevinAlberto01/3.MachineLearning/blob/main/0.Roadmap/1.FundamentalsML/2.HousePricePrediction/Img/2.AdvanceModel.png?raw=true" alt="Advanced Model" style="width: 100%; height: auto;">|<img src="https://github.com/KevinAlberto01/3.MachineLearning/blob/main/0.Roadmap/1.FundamentalsML/2.HousePricePrediction/Img/2.AdvanceModel.png?raw=true" alt="Deployment" style="width: 100%; height: auto;">|

<h2 id="movies" align="center">3. Sentiment Analysis (Movie Reviews)</h2>

<h4 id="objectives3" align="center">🎯 Objectives 🎯</h4>

Analyze movie reviews to classify sentiment (positive or negative).

<h4 id="focus3" align="center">🔎 Focus 🔎</h4>

Natural Language Processing (NLP) and text analysis techniques to extract semantic patterns.

<h4 id="results3" align="center">✅ Results ✅</h4>
