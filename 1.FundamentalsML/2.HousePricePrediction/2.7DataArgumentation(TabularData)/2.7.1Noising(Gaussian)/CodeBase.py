...
output_path = '/home/kevin/Desktop/Kevin/3.MachineLearning/1.FundamentalsML/2.HousePricePrediction/1.6DataArgumentation(TabularData)/1.6.2Noising(Gaussian)/AmesHousing_augmented_gaussian.csv'
