...
# Save results
results.to_csv('/home/kevin/Desktop/Kevin/3.MachineLearning/1.FundamentalsML/2.HousePricePrediction/2.7Optimization(Tuning&Hyperparameters)/AmesHousing_cleaned.csv', index=False)
