...
|----------|---------------------|
**Pandas** is imported, an essential library in Python for data manipulation and analysis.| <img src = "https://github.com/KevinAlberto01/3.MachineLearning/blob/main/1.FundamentalsML/2.HousePricePrediction/2.1DataProcessing/Images/1.ImportLibraries.png" width="4000"/>|
**`file_path`:** is defined with the location of the AmesHousing.csv file. <br> **`pd.read_csv(file_path):`** loads the CSV file into a Pandas DataFrame (df).| <img src = "https://github.com/KevinAlberto01/3.MachineLearning/blob/main/1.FundamentalsML/2.HousePricePrediction/2.1DataProcessing/Images/2.LoadDataset.png" width="4000"/>|
**`df.info():`** shows information about the dataset, such as data types, the number of non-null values, and columns. <br> **`df.describe():`** provides descriptive statistics of the numerical columns (mean, median, standard deviation, etc.).|<img src = "https://github.com/KevinAlberto01/3.MachineLearning/blob/main/1.FundamentalsML/2.HousePricePrediction/2.1DataProcessing/Images/3.DataInspection.png" width="4000"/>|
**`num_cols`:** Gets all the numeric columns (**`int64`**, **`float64`**). <br> **`cat_cols`**: Gets all the categorical columns (**`object`**).| <img src = "https://github.com/KevinAlberto01/3.MachineLearning/blob/main/1.FundamentalsML/2.HousePricePrediction/2.1DataProcessing/Images/4.ColumnClassification.png" width="4000"/>|
5.1 Filling Missing Values in Numeric Columns <br> For each column in **`num_cols`**, the missing values (**NaN**) are filled with the **median** of the column. <br> **`inplace=True`** modifies **`df`** directly. <br> 5.2 Filling Missing Values in Categorical Columns <br> For each column in **`cat_cols`**, the missing values are replaced with **`'Missing'`.** <br> 5.3 Standardization of Column Names <br>Convert the column names to **lowercase**.<br> Replace spaces with **"_"**. <br> Remove whitespace around the column name.| <img src = "https://github.com/KevinAlberto01/3.MachineLearning/blob/main/1.FundamentalsML/2.HousePricePrediction/2.1DataProcessing/Images/5.CleaningData.png" width="4000"/>|
Save the cleaned dataset in two different paths without including the index (**`index=False`**).| <img src = "https://github.com/KevinAlberto01/3.MachineLearning/blob/main/1.FundamentalsML/2.HousePricePrediction/2.1DataProcessing/Images/6.SaveCleaned.png" width="4000"/>|
Show **`df.info()`** and **`df.describe()`** again after the cleaning. <br> Print the location where the clean dataset was saved.| <img src = "https://github.com/KevinAlberto01/3.MachineLearning/blob/main/1.FundamentalsML/2.HousePricePrediction/2.1DataProcessing/Images/7.DataInspection.png" width="4000"/>|