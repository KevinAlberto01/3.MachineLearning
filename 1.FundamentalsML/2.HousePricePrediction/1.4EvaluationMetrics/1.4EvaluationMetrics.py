...
plt.bar(x + width/2, df_results['Test RMSE'], width=width, label='Test RMSE', color='orange')
...
plt.bar(x + width/2, df_results['Test R²'], width=width, label='Test R²', color='salmon')
plt.xticks(x, df_results['Model'], rotation=45)
plt.ylabel('R²')
