...
results_df.to_csv('/home/kevin/Desktop/Kevin/3.MachineLearning/1.FundamentalsML/2.HousePricePrediction/1.6DataArgumentation(TabularData)/1.6.4KNN(SyntheticData)/results_knn_synthetic_data.csv', index=False)
...
plt.subplot(1, 2, 2)
sns.barplot(x='Model', y='Test R²', data=results_df, palette='plasma')
