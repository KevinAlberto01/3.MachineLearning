...
# Save results to CSV
results_df.to_csv('/home/kevin/Desktop/Kevin/3.MachineLearning/1.FundamentalsML/2.HousePricePrediction/1.6DataArgumentation(TabularData)/1.6.5GenerativeDataArgumentation/results_feature_engineering.csv', index=False)
...
plt.savefig('/home/kevin/Desktop/Kevin/3.MachineLearning/1.FundamentalsML/2.HousePricePrediction/1.6DataArgumentation(TabularData)/1.6.5GenerativeDataArgumentation/model_comparison_plot.png')
