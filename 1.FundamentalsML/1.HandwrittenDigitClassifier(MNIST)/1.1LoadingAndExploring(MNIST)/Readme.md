...
<p style="text-align: left;">
    ...
    <img src="https://github.com/KevinAlberto01/3.MachineLearning/blob/main/1.FundamentalsML/1.HandwrittenDigitClassifier(MNIST)/1.1LoadingAndExploring(MNIST)/Images/Histogram.png" alt="Histogram" width="300" style="display: inline; float; rigth; margin-left; 10px;"/>
</p>
